                                    ...
                                    if files:
                                        ...
                                        if selected_display:
                                            ...
                                            if is_valid:
                                                ...
                                                is_different_file = (
                                                    'network_file_name' not in st.session_state or
                                                    st.session_state.get('network_file_name') != filename
                                                )
                                                
                                                # Show appropriate button based on file state
                                                if 'network_file' in st.session_state and st.session_state.get('network_file_name') == filename and st.session_state.get('file_loaded'):
                                                    # File is already loaded
                                                    st.success(f"📄 File ready for processing: **{filename}**")
                                                    
                                                    if st.button("❌ Remove File and Start Over", type="secondary", key="remove_loaded_file"):
                                                        self._clear_all_session_state()
                                                        st.success("🔄 File and all cached data removed. Please select a new file.")
                                                        st.rerun()
                                                else:
                                                    # File not loaded or different file selected
                                                    if st.button("✅ Confirm and Load File", type="primary", key="confirm_file_load"):
                                                        # Clear previous file data before loading new file
                                                        self._clear_all_session_state()
                                                ...
                                                # Set uploaded_file for processing if file is loaded
